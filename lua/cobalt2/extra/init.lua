...
function M.setup()
  local cobalt2 = require("cobalt2.theme")
  ...
  -- cobalt2.setup({ plugins = { all = true } })
  for _, extra in ipairs(names) do
    local info = M.extras[extra]
    local plugin = require("cobalt2.extra." .. extra)
    for style, style_name in pairs(styles) do
      local colors, groups, opts = cobalt2.setup({ style = style, plugins = { all = true } })
      local fname = extra
      ...
      colors["_upstream_url"] = "https://github.com/Addeuz/cobalt2.nvim/raw/main/extras/" .. fname
      colors["_style_name"] = "Cobalt 2" .. style_name
      colors["_name"] = "cobalt2_" .. style
      colors["_style"] = style
      print("[write] " .. fname)
