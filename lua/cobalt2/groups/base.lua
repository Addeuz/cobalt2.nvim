...
function M.get(c, opts)
  ...
  return {
    ...
    CursorLineNr                = { fg = c.yellow, bold = true }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    ...
    Special                     = { fg = c.teal }, -- (preferred) any special symbol
