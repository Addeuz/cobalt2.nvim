...
**Cobalt2** creates almost 900 highlight groups, so it was about time to refactor the code :)
...
## Bonus: `cobalt2` Dev Environment

Mostly for my owe use, but I've added a `cobalt2` dev environment to the repo,
